        ...
        <div class="slideshow-container" id="slides">
                ...
                <div class="slide">
                    <div class="text">
                        ...
                        <ul>
                            ...
                            <li>We will do our best to complete your full shopping list but we cannot guarantee that;
                                due to current circumstances. </li>
                            <li>In case of out of stock items, we will bring other similar items unless you notify us
                                otherwise in advance.</li>
                            <li>In case you received partial delivery, we will refund you the amount of missing items;
                                this will take up to 5-10 days according to your bank (unless you are happy to keep it
                                as credit for next order)</li>
                            <li>We collect the orders during the day, but delivery will take up to 24 hours, depend on
                                orders we have. </li>
                ...
                <div class="slide">
                    <div class="text">
                        <ul>
                            ...
                            <li>we are trying to keep prices updated on our website but some prices could not reflect
                                the actual price in the shops</li>
            ...
            <div class="mySlides fade">
                <div class="slide">
                    <div class="text">
                        <ul>
                            <li><span><i class="fas fa-cart-arrow-down"></i></span><span>You order your favorite
                                    products online</span></li>
                            <li><span><i class="fas fa-shopping-bag"></i></span><span>A personal assistant collects the
                                    products from your list</span></li>
                            <li><span><i class="fas fa-truck"></i></span><span>We deliver to the door at a time
        ...
        if(is_array($product) && !empty($product)){
            ...
            <div class="card-product">
                ...
                <div class="card-price-content">
                    <span>£<?=$row['product_price']?></span><a class="pdt-add"
                        onclick="cart.add(<?= $row['product_id'] ?>);"><i class="fas fa-shopping-cart">+</i></a>
                </div>
            </div>
            <?php }
        }else{
